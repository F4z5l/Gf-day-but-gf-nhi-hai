...
❤️`;
    ...
    function initSurprise() {
        ...
        button.addEventListener('click', function() {
            ...
            alert('💖 I LOVE YOU! Happy Girlfriend Day! 💖');
    ...
    function initMouseFollower() {
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            const hearts = ['❤️', '💕', '💗'];
            if (Math.random() > 0.98) {
                follower.textContent = hearts[Math.floor(Math.random() * hearts.length)];
